...
//                                 long id)
    ...
    public String jsonParseInfo(JSONObject jsonObject){

        try {
            mPrice = jsonObject.getString("last");
            Log.d("Bitcoin", "The last price is " + mPrice);
            updateUI(mPrice);
            return mPrice;
    ...
    public void updateUI(String Price){
        Log.d("Bitcoin", "The last price 2 is " + mPrice);
